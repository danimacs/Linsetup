...
<h1><a href=".././index.php">PROJECT</a></h1>
   ...
   <?php if(!isset($_SESSION['user_identify'])):?>
    ...
    <main>
        ...
        <p>PROJECT ("us", "we", or "our") uses cookies on the www.PROJECT.com website (the "Service"). By using the Service, you consent to the use of cookies.</p>
        ...
        <h2>How PROJECT uses cookies</h2>
