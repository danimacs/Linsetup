    ...
    $checkemail = mysqli_query($db, $sql);
 	...
 	if ($checkemail->num_rows != 0){
         ...
         if (count($errors) == 0) {
             ...
             $sql = "INSERT INTO users VALUE (null, '$user', '$email', '$password_secure', NOW(), null, 0, 0);";
             ...
             header("Location: ../.././validate_data/user_data/send_email_verificate.php?user_id=$user_id");
