...
(1, 'Google Chrome', 'google-chrome-logo.png', 1, 'cd /tmp/ && wget https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb', 'google-chrome-stable_current_amd64.deb', 0, 'dpkg -i'),
...
(18, 'Apache2', 'apache2-logo.png', 5, NULL, 'apache2', 0, 'apt install'),
(19, 'PHP', 'php-logo.png', 5, NULL, 'php', 0, 'apt install'),
